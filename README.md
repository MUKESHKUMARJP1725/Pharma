...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-5">
        <img src="aj.jpeg" class="img-fluid" alt="Pharmacy Image" width="2000" height="2000">
      </div>
      <div class="col-md-4">
        <img src="prr.jpeg" class="img-fluid" alt="Pharmacy Image" width="2000" height="2000">
      </div>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 PharmaCompany-Mopuri Ankitha.All rights reserved.</p>
  </footer>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="pankaj.png" class="card-img-top" alt="Product 1">
            <div class="card-body">
          ...
          <div class="card">
            <img src="health.png" class="card-img-top" alt="Product 2">
            <div class="card-body">
          ...
          <div class="card">
            <img src="nutri.png" class="card-img-top" alt="Product 3">
            <div class="card-body">
...
```
## OUTPUT:
![alt text](<Screenshot 2024-05-11 010801.png>)
![alt text](<Screenshot 2024-05-11 010827.png>)
![alt text](<Screenshot 2024-05-11 010856.png>)
![alt text](<Screenshot 2024-05-11 010911.png>)
## RESULT:
